...
const tiers: PricingTier[] = [
  {
    ...
    ctaHref: "/get-started",
    features: [
      { name: "3 uploads per week", included: true },
      { name: "1 subject", included: true },
      { name: "Basic flashcards", included: true },
      { name: "Quiz & lesson generation", included: true },
      { name: "Advanced flashcards", included: false },
      { name: "All 8 subjects", included: false },
  ...
  },
  {
    ...
    ctaHref: "/get-started",
    features: [
      { name: "20 uploads per week", included: true },
      { name: "Advanced flashcards", included: true },
      { name: "All 8 subjects", included: true },
      { name: "Quiz & lesson generation", included: true },
      { name: "Up to 20 questions per gen", included: true },
      { name: "Unlimited uploads", included: false },
      { name: "Export flashcards & quizzes", included: false },
    ],
  },
  {
    name: "Pro",
    ...
    features: [
      ...
      { name: "All 8 subjects", included: true },
      { name: "Quiz & lesson generation", included: true },
      { name: "Up to 50 questions per gen", included: true },
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <Link
                href={tier.ctaHref}
                className={cn(
                  "group relative flex h-12 items-center justify-center overflow-hidden rounded-full text-sm font-bold transition-all duration-200",
                  tier.highlight
